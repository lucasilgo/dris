...
class CalculateForm(forms.Form):
    ...
    cultura = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control'}))
    amostra = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Quem o tipo da amostra?'}))
    data_coleta = forms.DateField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Quando a coleta foi feita? Ex: 12/02/2014'}))